    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:-15px">
                        <img src="<?=base_url()?>public/images/logo.png" alt="logo" class="img-responsive" width="50px">
                    </a>
                </div>
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                ...
                Copyright <a href="http://www.stackheaps.com">Stack Heaps</a> (<?php echo date('Y'); ?>)
            </p>
        </footer>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header hidden-print">
                        ...
                        <h2 class="text-center">POKKET CAFE</h2>
