...
<?php if($allTransInfo):?>
<?php $sn = 1; ?>
<form id="transReceiptForm" name="transReceiptForm">
<div id="transReceiptToPrint">
    <div class="row">
        <div class="col-xs-12 text-center text-uppercase">
            ...
            <b>Shop No. 4, Visamo Building, TPS Road,</b>
            <b>Opp. Veer Savarkar Udyan ,Gate No.2, Babhai Naka,</b>
            <b>Borivali West, Mumbai, Maharashtra 400092.</b>
            <div><b>Mobile No : </b>+91  083691 35645</div>
        </div>
    </div>
